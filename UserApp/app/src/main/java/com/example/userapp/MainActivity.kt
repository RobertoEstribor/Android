...
class MainActivity : AppCompatActivity() {
    ...
    private fun checkCompanyCodeAndFetchUsers(forceShowDialog: Boolean = false) {
        ...
        if (companyCode == null || forceShowDialog) {
            ...
            binding.companyCodeStatusText.text = "Company Code: $companyCode. Fetching users..."
        ...
        AlertDialog.Builder(this)
            ...
            .setPositiveButton("Save") { dialog, _ ->
                ...
                if (code.isNotBlank()) {
                    ...
                    binding.companyCodeStatusText.text = "Company Code: $code. Fetching users..."
                    fetchUsers(code)
                } else {
                    Toast.makeText(this, "Company code cannot be empty", Toast.LENGTH_SHORT).show()
                    binding.companyCodeStatusText.text = "Company code not set. Navigating to login..."
            ...
            .setOnDismissListener {
                if (CompanyCodeManager.getCompanyCode(this) == null) {
                     if (!binding.companyCodeStatusText.text.toString().endsWith("Navigating to login...")) {
                        binding.companyCodeStatusText.text = "Company code entry skipped. Navigating to login..."
                        navigateToLogin()
                     }
                }
            }
